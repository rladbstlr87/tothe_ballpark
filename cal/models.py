...
class Hitter_Daily(models.Model):
    ...
    date = models.DateField(max_length = 100)
    player = models.ForeignKey(Hitter, on_delete=models.CASCADE, to_field='player_id', db_column='player_id')
...
class Pitcher_Daily(models.Model):
    game_id = models.ForeignKey(Game, on_delete=models.CASCADE)
    date = models.DateField(max_length = 100)
    player = models.ForeignKey(Pitcher, on_delete=models.CASCADE, to_field='player_id', db_column='player_id')
    team = models.CharField(max_length=50)
